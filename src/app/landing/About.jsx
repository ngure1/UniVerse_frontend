...
const About = () => {
	return (
		<Element className="flex flex-col justify-center items-center py-[1.5rem] px-0 gap-[2.25rem]" name="whyJoinUs">
			...
			<div className="flex w-full py-0 px-[2.5rem] justify-center items-center gap-[4.75rem]">
				<div className="w-[31.5rem] flex flex-col px-[2.125rem] py-[1.125rem] items-center gap-[1rem] rounded-[0.5rem] border border-solid border-[#00B595] bg-white shadow-xl">
					...
					<p className="muted body-text text-center">
