    ...
    return(
        ...
        <div className="flex flex-col justify-center items-start w-[28.75rem] p-[1.25rem] gap-[2.25rem]">
           <div className="flex flex-col justify-center items-center gap-[2rem] self-stretch">
                <p className="text-[#0F0F0F] text-justify sub-heading-3">SIGNUP</p>
               ...
               <div className="flex items-center gap-[0.75rem] self-stretch"> 
                ...
                <label className="text-black body-text" htmlFor="first_name">First Name</label>
                    <input type="text"
            ...
            <div className="flex flex-1 flex-grow-0 flex-shrink-0 flex-col justify-center items-start gap-[0.25rem] ">
                <label className="text-black body-text" htmlFor="last_name">Last Name</label>
                <input type="text"
                    name ="last_name"
        ...
        <div className="flex flex-col justify-center items-start gap-[0.5rem] ml-[-1.25rem]">
             ...
             <p  className=" text-[#008BF8] body-text">Already have an account? <a href="./login" className="text-black body-text">Login</a></p>
    

            <Button variant="outline" className="flex py-[0.625rem] px-[0.75rem] justify-center items-center gap-[0.5rem]">
