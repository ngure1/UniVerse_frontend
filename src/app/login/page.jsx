        ...
        <div className="inline-flex pt-[14.0625rem] pr-[0.625rem] pb-[0.01rem] pl-[0.625rem] flex-col justify-end items-center gap-[18.375rem] ">
            <div className="flex flex-col items-start gap-[2.375rem]">
                ...
                <div className ="flex flex-col justify-center items-start gap-[0.25rem]"> 
                    <label htmlFor="email" className="text-black body-text">Email</label>
                        <input 
                    ...
                    <div class ="flex flex-col justify-center items-start gap-[0.25rem]">
                        <label htmlFor="password " className="text-black body-text">Password</label>
                        <input className="flex w-[18.75rem] h-[2.75rem] py-[0.625rem] px-[1rem] items-center gap-[0.625rem] rounded-[0.625rem] border border-solid border-black"
                        type="text"
                        name = "password"
                        id = "password"
                ...
                <a href="" className="text-[#008BF8] body-text ">Forgot Password?</a>
                <p className="text-[#008BF8] body-text">Don't have an account? <a href="./signup" className="text-[#0F0F0F] body-underline">SignUp</a></p>
                </div>
    </div>
                <Footer/>
